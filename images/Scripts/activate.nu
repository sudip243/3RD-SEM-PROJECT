...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\SUDIPTO\PycharmProjects\FaceRecognitionRealTimeDatabase\venv'
    let bin = 'Scripts'
    let path_sep = ';'
...
alias deactivate = source 'C:\Users\SUDIPTO\PycharmProjects\FaceRecognitionRealTimeDatabase\venv\Scripts\deactivate.nu'
